...
const steps = [
    {
        ...
        skills: [
            { id: "s1", name: "Créer des wireframes", description: "Capacité à créer des maquettes basse fidélité." },
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            Projet : <span className="font-medium text-gray-800">Refonte Site E-commerce</span>
                        </p>
                    </div>
                    ...
                    <div className="overflow-auto flex-1 relative custom-scrollbar">
                        <table className="border-separate border-spacing-0">
                            <thead>
                                {/* Steps Header */}
                                <tr>
                                    <th className="sticky top-0 left-0 z-30 bg-white p-4 border-b border-r border-gray-200 whitespace-nowrap h-16">
                                ...
                                <tr>
                                    ...
                                    {allSkills.map((skill) => (
                                        <th
                                            key={skill.id}
                                            className="sticky top-16 z-20 bg-white p-4 border-b border-r border-gray-200 min-w-[140px] w-[140px] align-bottom hover:bg-gray-50 transition-colors group cursor-help"
                                            title={skill.description}
                                        >
                                            <div className="writing-mode-vertical transform rotate-180 text-left h-32 flex items-center">
                                        ...
                                        {allSkills.map((skill) => {
                                            ...
                                            return (
                                                <td
                                                    ...
                                                    className="p-2 border-b border-r border-gray-100 bg-white hover:bg-gray-50 transition-all cursor-pointer text-center relative"
                                                >
                                                    <div
